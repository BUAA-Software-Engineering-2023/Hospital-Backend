...
from .views import LoginView, DoctorManagement, ScheduleManage, DepartmentManage, NotificationManage, \
    LeaveListManage, ProcessLeave, vacancy_check, VacancySettingManage, UploadImage, NewsManage, \
    ChangeAdminPasswd, AdminIntroduction, ProcessedLeave
...
urlpatterns = [
    ...
    path('api/processedLeave', ProcessedLeave.as_view()),
